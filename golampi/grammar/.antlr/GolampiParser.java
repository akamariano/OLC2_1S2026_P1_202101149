...
public class GolampiParser extends Parser {
	...
	public static final int
		...
		T__9=10, T__10=11, T__11=12, T__12=13, T__13=14, T__14=15, FUNC=16, VAR=17, 
		CONST=18, IF=19, ELSE=20, FOR=21, SWITCH=22, CASE=23, DEFAULT=24, BREAK=25, 
		CONTINUE=26, RETURN=27, TRUE=28, FALSE=29, NIL=30, INT_TYPE=31, FLOAT_TYPE=32, 
		STRING_TYPE=33, BOOL_TYPE=34, RUNE_TYPE=35, ADD_ASSIGN=36, SUB_ASSIGN=37, 
		MUL_ASSIGN=38, DIV_ASSIGN=39, OR=40, AND=41, EQ=42, NEQ=43, GTE=44, LTE=45, 
		GT=46, LT=47, PLUS=48, MINUS=49, STAR=50, SLASH=51, MOD=52, BANG=53, REF=54, 
		ID=55, FLOAT=56, INT=57, STRING=58, RUNE=59, LINE_COMMENT=60, BLOCK_COMMENT=61, 
		WS=62;
	public static final int
		...
		RULE_expression = 39, RULE_logicalOr = 40, RULE_logicalXor = 41, RULE_logicalAnd = 42, 
		RULE_equality = 43, RULE_comparison = 44, RULE_term = 45, RULE_factor = 46, 
		RULE_unary = 47, RULE_primary = 48, RULE_typeCast = 49, RULE_type = 50;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SWITCH", "CASE", "DEFAULT", "BREAK", "CONTINUE", "RETURN", "TRUE", "FALSE", 
			"NIL", "INT_TYPE", "FLOAT_TYPE", "STRING_TYPE", "BOOL_TYPE", "RUNE_TYPE", 
			"ADD_ASSIGN", "SUB_ASSIGN", "MUL_ASSIGN", "DIV_ASSIGN", "OR", "AND", 
			"EQ", "NEQ", "GTE", "LTE", "GT", "LT", "PLUS", "MINUS", "STAR", "SLASH", 
			"MOD", "BANG", "REF", "ID", "FLOAT", "INT", "STRING", "RUNE", "LINE_COMMENT", 
			"BLOCK_COMMENT", "WS"
		};
	}
	...
	public final FunctionDeclContext functionDecl() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1125966478835730L) != 0)) {
				{
				setState(118);
				returnType();
				}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1127588825396019266L) != 0)) {
				{
				{
				setState(186);
				statement();
	...
	public final ArrayLiteralContext arrayLiteral() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1127588825153929218L) != 0)) {
					{
					setState(330);
					arrayElements();
					}
	...
	public final AssignOpContext assignOp() throws RecognitionException {
		...
		try {
			...
			setState(426);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1030792151552L) != 0)) ) {
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1145603223663411202L) != 0)) {
				{
				setState(532);
				argList();
				}
	...
	public final LogicalXorContext logicalXor() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_logicalXor);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final LogicalAndContext logicalAnd() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_logicalAnd);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final EqualityContext equality() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_equality);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
