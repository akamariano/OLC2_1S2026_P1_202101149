...
interface GolampiListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@see GolampiParser::logicalXor()}.
	 * @param $context The parse tree.
	 */
	public function enterLogicalXor(Context\LogicalXorContext $context): void;
	/**
	 * Exit a parse tree produced by {@see GolampiParser::logicalXor()}.
	 * @param $context The parse tree.
	 */
	public function exitLogicalXor(Context\LogicalXorContext $context): void;
	/**
