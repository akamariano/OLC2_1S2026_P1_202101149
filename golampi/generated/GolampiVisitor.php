...
interface GolampiVisitor extends ParseTreeVisitor
{
	...
	/**
	 * Visit a parse tree produced by {@see GolampiParser::logicalXor()}.
	 *
	 * @param Context\LogicalXorContext $context The parse tree.
	 *
	 * @return mixed The visitor result.
	 */
	public function visitLogicalXor(Context\LogicalXorContext $context);
